...
export function Card(props: {
  ...
  return (
    ...
    >
      <div
        class={`flex flex-col sm:flex-row  text-white  bg-gray-900  p-2 rounded-lg`}
      >
